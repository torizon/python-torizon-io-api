...
class PaginationResultUserSession(BaseModel):
    """
    PaginationResultUserSession
    """ # noqa: E501
    values: Optional[List[UserSession]] = None
    total: StrictInt
    offset: StrictInt
    limit: StrictInt
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "values": [UserSession.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None,
            "total": obj.get("total"),
